...
# Finetune Cascade Mask R-CNN + MambaVision-S backbone on COCO
...
BATCH_SIZE_PER_GPU=${BATCH_SIZE_PER_GPU:-$((TOTAL_BATCH_SIZE / NUM_GPUS))}
CONFIG="./configs/mamba_vision/mask_rcnn_mamba_vision_s_1x_coco.py"
PRETRAIN="/mnt/data/${MODEL}-224/model_best.pth.tar"  # Path to pretrained weights
