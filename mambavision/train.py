...
from timm.loss import JsdCrossEntropy, BinaryCrossEntropy, SoftTargetCrossEntropy, BinaryCrossEntropy, LabelSmoothingCrossEntropy
...
group.add_argument('--train-split',
                   metavar='NAME',
                   default='train',
                   help='dataset train split (default: train)')
group.add_argument('--val-split',
                   metavar='NAME',
                   default='validation',
...
group.add_argument('--model-source',
                   default='mamba_vision',
                   help='Which models module to import/register before creating the model')
group.add_argument(
    '--pretrained',
    action='store_true',
    default=False,
...
group.add_argument('--num-classes',
                   type=int,
                   default=None,
                   metavar='N',
...
group.add_argument('--interpolation',
                   default='',
                   type=str,
                   metavar='NAME',
...
group.add_argument('--channels-last',
                   action='store_true',
                   default=False,
                   help='Use channels_last memory layout')
scripting_group = group.add_mutually_exclusive_group()
scripting_group.add_argument('--torchscript',
                             dest='torchscript',
                             action='store_true',
...
group.add_argument('--opt',
                   default='adamw',
                   type=str,
                   metavar='OPTIMIZER',
                   help='Optimizer (default: "sgd"')
group.add_argument('--opt-eps',
                   default=1e-8,
                   type=float,
                   metavar='EPSILON',
                   help='Optimizer Epsilon (default: 1e-8, use opt default)')
group.add_argument('--opt-betas',
                   default=[0.9, 0.999],
                   type=float,
                   nargs='+',
                   metavar='BETA',
...
group.add_argument('--layer-decay',
                   type=float,
                   default=None,
...
group.add_argument('--sched',
                   default='cosine',
                   type=str,
                   metavar='SCHEDULER',
                   help='LR scheduler (default: "step"')
parser.add_argument('--lr-ep',
                    action='store_true',
                    default=False,
...
group.add_argument('--lr-noise',
                   type=float,
                   nargs='+',
                   default=None,
                   metavar='pct, pct',
                   help='learning rate noise on/off epoch percentages')
group.add_argument('--lr-noise-pct',
                   type=float,
                   default=0.67,
                   metavar='PERCENT',
                   help='learning rate noise limit percent (default: 0.67)')
group.add_argument('--lr-noise-std',
                   type=float,
                   default=1.0,
                   metavar='STDDEV',
                   help='learning rate noise std-dev (default: 1.0)')
group.add_argument('--lr-cycle-mul',
                   type=float,
                   default=1.0,
                   metavar='MULT',
...
group.add_argument('--lr-cycle-limit',
                   type=int,
                   default=1,
                   metavar='N',
                   help='learning rate cycle limit, cycles enabled if > 1')
group.add_argument('--lr-k-decay',
                   type=float,
                   default=1.0,
                   help='learning rate k-decay for cosine/poly (default: 1.0)')
group.add_argument('--warmup-lr',
                   type=float,
                   default=1e-6,
                   metavar='LR',
...
group.add_argument('--start-epoch',
                   default=None,
                   type=int,
                   metavar='N',
...
group.add_argument('--decay-epochs',
                   type=float,
                   default=100,
                   metavar='N',
                   help='epoch interval to decay LR')
group.add_argument('--warmup-epochs',
                   type=int,
                   default=20,
                   metavar='N',
...
group.add_argument('--ratio',
                   type=float,
                   nargs='+',
                   default=[3. / 4., 4. / 3.],
                   metavar='RATIO',
                   help='Random resize aspect ratio (default: 0.75 1.33)')
group.add_argument('--hflip',
                   type=float,
                   default=0.5,
                   help='Horizontal flip training aug probability')
group.add_argument('--vflip',
                   type=float,
                   default=0.,
...
group.add_argument('--resplit',
                   action='store_true',
                   default=False,
                   help='Do not random erase first (clean) augmentation split')
group.add_argument('--mixup',
                   type=float,
                   default=0.8,
                   help='mixup alpha, mixup enabled if > 0. (default: 0.8)')
group.add_argument('--cutmix',
                   type=float,
                   default=1.0,
...
group.add_argument('--drop-path',
                   type=float,
                   default=None,
                   metavar='PCT',
                   help='Drop path rate (default: None)')
group.add_argument('--drop-block',
                   type=float,
                   default=None,
                   metavar='PCT',
                   help='Drop block rate (default: None)')
group.add_argument('--attn-drop-rate',
                   type=float,
                   default=0.0,
                   metavar='PCT',
...
group.add_argument('--bn-momentum',
                   type=float,
                   default=None,
                   help='BatchNorm momentum override (if not None)')
group.add_argument('--bn-eps',
                   type=float,
                   default=None,
                   help='BatchNorm epsilon override (if not None)')
group.add_argument('--sync-bn',
                   action='store_true',
...
group.add_argument('--worker-seeding',
                   type=str,
                   default='all',
...
group.add_argument('--checkpoint-hist',
                   type=int,
                   default=1,
                   metavar='N',
...
group.add_argument('--apex-amp',
                   action='store_true',
                   default=False,
                   help='Use NVIDIA Apex AMP mixed precision')
group.add_argument('--native-amp',
                   action='store_true',
                   default=False,
                   help='Use Native Torch AMP mixed precision')
group.add_argument('--no-ddp-bb',
                   action='store_true',
                   default=False,
...
group.add_argument('--no-prefetcher',
                   action='store_true',
                   default=False,
...
group.add_argument('--eval-metric',
                   default='top1',
                   type=str,
                   metavar='EVAL_METRIC',
...
group.add_argument('--log-wandb',
                   action='store_true',
                   default=False,
                   help='log training and validation metrics to wandb')
group.add_argument('--validate_only',
                   action='store_true',
                   default=False,
                   help='run model validation only')

group.add_argument('--no_saver',
                   action='store_true',
                   default=False,
                   help='Save checkpoints')
group.add_argument('--ampere_sparsity',
                   action='store_true',
                   default=False,
                   help='Save checkpoints')
group.add_argument('--lmdb_dataset',
                   action='store_true',
                   default=False,
                   help='use lmdb dataset')
group.add_argument('--bfloat',
                   action='store_true',
                   default=False,
...
def _import_model_source(source: str):
    """Import the selected models module so its models register with timm."""
    module_name = f"models.{source}"
    try:
        importlib.import_module(module_name)
    except ImportError as exc:
        raise RuntimeError(f"Failed to import model source {module_name}") from exc
...
def main():
    ...
    _import_model_source(args.model_source)
    ...
    if args.resume:
        ...
        # 手动清理内存，防止加载巨大的checkpoint导致内存碎片化或swap，影响后续dataloader性能
        import gc
        gc.collect()
        try:
            import ctypes
    ...
    if args.loadcheckpoint:
        _logger.info(
            f"Loading checkpoint {args.loadcheckpoint}, checking for existing parameters if their shape match"
        )
    ...
    if args.lmdb_dataset:
        ...
        if 'lmdb' in args.data_dir:
            dataset_train = imagenet_lmdb_dataset(train_dir, transform=None)
        else:
        ...
        if 'lmdb' in args.data_dir:
            dataset_eval = imagenet_lmdb_dataset(eval_dir, transform=None)
        else:
            if not os.path.isdir(eval_dir):
                eval_dir = os.path.join(args.data_dir, 'validation')
                if not os.path.isdir(eval_dir):
                    _logger.error(
                        'Validation folder does not exist at: {}'.format(
                            eval_dir))
                    exit(1)
    ...
    if args.rank == 0:
        ...
        output_dir = utils.get_outdir(
            args.output if args.output else '/mnt/data/mambavision', exp_name)
    ...
    try:
        for epoch in range(start_epoch, num_epochs):
            ...
            if log_writer is not None:
                log_writer.update(test_acc1=eval_metrics['top1'],
                                  head="perf",
                                  step=epoch)
                log_writer.update(test_loss=eval_metrics['loss'],
                                  head="perf",
                                  step=epoch)
                log_writer.update(train_loss=train_metrics['loss'],
                                  head="perf",
                                  step=epoch)
                lrl = [
            ...
            stopif = True if len(
                test_acc_track) > 1 and test_acc_track[-1] < 1.0 else False

            if model_ema is not None and not args.model_ema_force_cpu:
                if args.distributed and args.dist_bn in ('broadcast',
                                                         'reduce'):
                    utils.distribute_bn(model_ema, args.world_size,
                                        args.dist_bn == 'reduce')
            ...
            if log_writer is not None:
                log_writer.update(test_acc1_ema=eval_metrics['top1'],
                                  head="perf",
                                  step=epoch)
                log_writer.update(test_loss_ema=eval_metrics['loss'],
                                  head="perf",
                                  step=epoch)
            ...
            if lr_scheduler is not None and args.lr_ep:
                ...
                lr_scheduler.step(
                    epoch + 1, None
                    if eval_metrics is None else eval_metrics[eval_metric])
            ...
            if saver is not None:
                ...
                save_metric = None if eval_metrics is None else eval_metrics[
                    eval_metric]
...
def train_one_epoch(epoch,
    ...
    for batch_idx, (input, target) in enumerate(loader):
        ...
        if lr_scheduler is not None and not args.lr_ep:
            lr_scheduler.step_update(num_updates=(epoch * num_iters) +
                                     batch_idx + 1)
        ...
        update_grad = (batch_idx +
                       1) % args.grad_accum_steps == 0 or last_batch
        if args.distributed and not update_grad:
        ...
        with context():
            ...
            if not args.distributed:
                losses_m.update(loss.item() * args.grad_accum_steps,
                                input.size(0))
            ...
            if loss_scaler is not None:
                ...
                elif isinstance(loss_scaler, ApexScaler):
        ...
        if last_batch or batch_idx % args.log_interval == 0:
            ...
            if args.distributed:
                ...
                losses_m.update(reduced_loss.item() * args.grad_accum_steps,
                                input.size(0))
